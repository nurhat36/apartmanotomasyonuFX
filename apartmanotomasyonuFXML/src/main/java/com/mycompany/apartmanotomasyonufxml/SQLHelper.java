...
public class SQLHelper {
    private static final String DB_URL = "jdbc:sqlserver://DEKSTOP-BT77ME7;databaseName=APARTMAN;integratedSecurity=True;encrypt=True;trustServerCertificate=True";
